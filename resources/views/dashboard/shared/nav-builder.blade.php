...
?>
      ...
      <div style='' class="c-sidebar-brand">
          <img class="c-sidebar-brand-full" style='position: absolute;left: 0;height: 10%;' src="/assets/brand/QHSE.png" width="118" height="46" alt="CoreUI Logo">
          <h4 style="margin-top: 13px;margin-left: 10px">QHSE</h4>
          <img class="c-sidebar-brand-minimized" src="/assets/brand/QHSE.png" width="118" height="46" alt="CoreUI Logo">
        </div>
